...
python3 -m mcp_server.test_mcp_server                    # asserts registration of all 7 MCP tools + 2 resources, and
                                                          # exercises all 7 tools' execution handlers (including
...
python3 scripts/load_ontology_tbox.py                        # ontology/*.ttl -> Neo4j TBox (:OntologyClass/:OntologyProperty),
                                                                # bridged to the lineage layer and the ABox -- must run after BOTH
                                                                # build_knowledge_graph.py and sync_end_to_end_lineage.py
